            ...
            <div className="mx-auto max-w-screen-lg px-4 pb-6 pt-16 sm:px-6 lg:px-8 scroll-my-0">
               ...
               {/* About spaceLink */}
                ...
                >
                    ...
                    <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
                        ...
                        <div className="mx-auto mt-2 max-w-md sm:ms-0">
                            <p
                                className=" font-bold leading-relaxed text-gray-500 ltr:sm:text-left rtl:sm:text-right dark:text-gray-400"
                            >
                                About SpaceLink Mission
                            </p>
                            ...
                            <form className="mt-2">
                                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                                    ...
                                    <button
                                        className="block rounded-full bg-indigo-500 px-8 py-2  font-medium text-white transition hover:bg-indigo-600"
                                        type="submit"
                                    >
                                        JOIN US
                                    </button>
                ...
                >
                    ...
                    <ul className="mt-2 flex justify-center gap-8 sm:mt-0 sm:justify-start">
                        <li>
                            <a
                                href="#"
                                rel="noreferrer"
